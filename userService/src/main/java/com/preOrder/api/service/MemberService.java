...
import com.preOrder.api.dto.request.LoginReqDto;
...
import com.preOrder.api.security.JwtAuthenticationFilter;
...
public class MemberService {
    ...
    public boolean login(LoginReqDto loginReqDto){
        var member= memberRepository.findById(Long.parseLong(loginReqDto.getLoginId())).orElseThrow();
        if (member.getHashedPw().equals(loginReqDto.getPassword())){
            return true;
        }
        return false;
    }
